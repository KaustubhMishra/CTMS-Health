...
let enrolledPatientCROCo = [];
let enrolledPatienTrialCROCo = [];
...
class PatientApi {
  ...
  static getPhasePatient(trialId) {
    console.log('Phase PATIENT API cALL.....');
  ...
  static getEnrolledPatientTrialCROCo(search) {
    var basicToken = "Bearer "+ cookies.load('access_token');
    ...
    return new Promise((resolve, reject) => {
        axios.post('/api/site/getEnrolledPhasePatientsTrialCROCo', search, config).then(response => {
          enrolledPatientCROCo = Object.assign([], response.data.data);
          resolve(enrolledPatientCROCo);
        }).catch(error => {
          throw(error);
        });
    });
  ...
  static getEnrolledTrialCROCo() {
    ...
    return new Promise((resolve, reject) => {
        axios.get('/api/site/getEnrolledTrialsCROCo', config).then(response => {
          enrolledPatienTrialCROCo = Object.assign([], response.data.data);
          resolve(enrolledPatienTrialCROCo);
        }).catch(error => {
          throw(error);
        });
    });
