  ...
  OnPageLoad() {
    $(document).ready(function(){
      ...
      $('.nav-icon').click(function(){
        ...
        $('#datetimePhaseStart0').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });

        $('#datetimePhaseEnd0').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });
        
        $('#datetimePhaseStart1').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });

        $('#datetimePhaseEnd1').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });

        $('#datetimePhaseStart2').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });

        $('#datetimePhaseEnd2').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });

        $('#datetimePhaseStart3').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });

        $('#datetimePhaseEnd3').click(function(){
          $('.bootstrap-datetimepicker-widget').removeClass("bottom");
          $('.bootstrap-datetimepicker-widget').addClass("top");
        });
...
*/
  ...
  saveTrial(event) {
   ...
   event.preventDefault();
    if (this.isValid()) {
      this.setState({ trialerrors: {} });
      if( (this.state.trial.pre_vital_type == true ||
           this.state.trial.post_vital_type == true
          ) && this.state.device.length <= 0) {
        toastr.error("Please add the Device");
        allValidationSuccess = false;
      } else if( (this.state.trial.pre_vital_type == false && 
                  this.state.trial.post_vital_type == false
                 ) && this.state.device.length > 0) {
  ...
  redirect() {
    ...
    if(this.props.params.id)
    {
      this.props.notificationActions.setNotificationsAction(this.props.params.id).then(function(){
        console.log('Notification Schedeuled........');
      });
              ...
              <section className="page-title">
                  <div className="pull-left">
                    ...
                    <div className="breadcrumbs">
                      <span>Trial</span><a >Manage Trial</a>
                    </div>
                  </div>
              </section>
              <div className="mt-box overflow-visible">
                  <TrialForm
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2">
                                <Link className="btn blue set-width"  to="/trials">Cancel</Link>
                        </div>
                    </div> 
