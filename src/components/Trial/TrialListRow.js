  ...
  return (
          <div className="at-panel"> 
                          ...
                          <li onClick={() => onCompeletedTrial(trial)}>
                            <Conditional condition={ userRoleName.name != 'DSMB' && userRoleName.name != 'CRO Coordinator'}>
                              <a  className="add-more-milestones-btn js-open-modal" href="javascript:void(0)" 
                                ...
                                <img src={require('../../assets/images/icon-logout.png')}/>
                              </a>
                            </Conditional>
                          </li>
                        </Conditional>  
                        <Conditional condition={ trial.status != 100 }>
                          <Conditional condition={ userRoleName.name != 'DSMB' && userRoleName.name != 'CRO Coordinator'}>
                            <li>
                              <Link to={'/trial/' + trial.id}>
                                <img src={require('../../assets/images/icon-edit-green.png')}/>
                              </Link>
                            </li>
                          </Conditional>
                          </Conditional> 
                          <li> 
                            <Link to={'/trialDetail/' + trial.id}>                                   
                              <img src={require('../../assets/images/icon-view.png')}/>
                            </Link>
                          </li>
                ...
                <div className="at-panel-body">
                      ...
                      <div className="ending-on"><label>Ending On:</label> <span>{ UTCtoUser.UTCtoUserTimezone(trial.end_date,timeZone) }</span></div>
