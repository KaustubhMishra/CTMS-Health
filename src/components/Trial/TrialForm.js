                ...
                <div id="trial" style={{display:"block"}}>
                     ...
                     <div className="clearfix">
                          <div className="phase-form-row pull-left overflow-visible start-date-field">
                            ...
                            <div className="date-picker">
                              <div className="input-group date trial-startDate">
                                <TextDate 
                                  id="add-trial-start"
                                  type="text" 
                                  name="start_date"
                          ...
                          <div className="phase-form-row pull-left overflow-visible end-date-field">
                            ...
                            <div className="date-picker1">
                              <div className="input-group date trial-endDate">
                                <TextDate 
                                  type="text" 
                                  name="end_date"
                  ...
                  <div id="phase">
                              ...
                              phase.map((phaseInfo, index) =>
                                  <div id={ "phase-" + index } style={{display:""}}>
                                      <div className="phase-form-wrap">
                                            ...
                                            <div className="clearfix">
                                              <div className="phase-form-row pull-left overflow-visible start-date-field">
                                                <label>Start Date:</label>
                                                <div className="date-picker">
                                                  <div id={"datetimePhaseStart" + index} className={"input-group date phase-startDate" + index}>
                                                    <TextDate 
                                                      type="text" 
                                                      name="start_date"
                                              ...
                                              <div className="phase-form-row pull-left overflow-visible end-date-field">
                                                <label>End Date:</label>
                                                <div className="date-picker">
                                                  <div id={"datetimePhaseEnd" + index} className={"input-group date phase-endDate" + index}>
                                                    <TextDate 
                                                      type="text" 
                                      ...
                                      <hr className="hairline-hr" />
                                       <MilestoneList  Phaseindex = {index}
                    ...
                    <div id="medication">
                      ...
                      <div className="trial-field-row">
                        ...
                        <ProductTable MedicationTimeList={MedicationTimeList} onRowAdd={onRowAdd} 
                                      onRowDel = {onRowDel} 
                  ...
                  <div id="device">
                    ...
                    <div className="trial-field-row">
                      ...
                      <div className="vital-last-field">
                          <CheckBoxInput  
                              name="pre_vital_type"
