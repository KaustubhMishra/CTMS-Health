...
class PatientEnrolledTrialPage extends React.Component {
  ...
  getEnrolledTrials() {
    if(this.props.userRoleName.name =="DSMB") {
      this.state.isPlaceboVisible = true;
    ...
    {
      this.props.actions.loadEnrolledPatientTrialCROCo(this.state);
      this.props.actions.loadEnrolledTrialsCROCo(); 
    }
  }
              ...
              <section className="container-fluid">
                ...
                <section className="box-trials">
                  ...
                  <div className="pt-data-table">
                    <PatientEnrolledListPage 
                        patientEnrolledList={this.props.patientEnrolledList} 
                        getPatientDetailedGraph={this.getPatientDetailedGraph} 
                        UsertimeZone={UsertimeZone}
                        isPlaceboVisible = {this.state.isPlaceboVisible}/>
                  </div>
