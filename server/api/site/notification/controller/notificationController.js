                                ...
                                patient.getNotificationUnreadCount(db.models, patient.id, function(totalunreadnotifications) {
                                    ...
                                    userobj.reload().then(() => {
                                        ...
                                        if(userobj.aws_target_arn!=null) {
                                            ...
                                            var requestcontent = '\r\n';
                                             requestcontent += '---------------------------------------------------------\r\n';
                                             requestcontent += 'Unable to Send Notification : saving to db-----------------------------------\r\n';
                                             requestcontent += '\r\n';
                                             requestcontent += '---Current Time : '+currentdatetime+'\r\n';
                                             requestcontent += '---Patient Name : '+patient.user.firstname+' '+patient.user.lastname+'\r\n';
                                             requestcontent += '\r\n';
                                             ...
                                             var pendingNotificationData = {};
                                             pendingNotificationData.patient_id = patient.id;
                                             pendingNotificationData.pushdata= JSON.stringify(pushdata);
 
                                             db.models.notification_backup.create(pendingNotificationData).then(function(data){
                                                 console.log("pendingNotificationData saved");
                                             })
                    ...
                    if(dosage) {
                        ...
                        if (diffInHours > 1) {
                            ...
                            dosage.getPreviousDosage(db.models, function(previousdosage) {
                                ...
                                if((!previousdosage) || previousdosage.status) {
                                    ...
                                    var outputdosage = dosage;
                                } else {
                                    previousdosage.setDataValue('isMissed', true);
                                    var outputdosage = previousdosage;
                                }
                            
                                outputdosage.setDataValue('totalUnreadNotifications', totalunreadnotifications);
                                res.json({
                                    status: true,
                                    data: outputdosage,
                                    message: 'Data load successfully'
                            ...
                            dosage.setDataValue('isMissed', false);
                            dosage.setDataValue('totalUnreadNotifications', totalunreadnotifications);                            
                            res.json({
                                status: true,
                                data: dosage,
                                message: 'Data load successfully'
                        ...
                        db.models.vital_dosage_status.findOne({
                            ...
                            if(previousdosage) {
                                ...
                                previousdosage.setDataValue('totalUnreadNotifications', totalunreadnotifications);
                                res.json({
                                    status: true,
                                    data: previousdosage,
                                    message: 'Data load successfully'
