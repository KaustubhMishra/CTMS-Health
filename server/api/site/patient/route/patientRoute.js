...
module.exports = function(app) {	
	...
	app.post('/api/site/getEnrolledPhasePatientsTrialCROCo',patientUser.getEnrolledPhasePatientsTrialsCROCo);
	app.get('/api/site/getEnrolledTrialsCROCo',patientUser.getEnrolledTrialsCROCo);
